...
var Grid = (function() {
	...
	function showPreview( $item ) {
		...
		console.log("it always reaches here");
		// update previewPos
		previewPos = position;
	...
	Preview.prototype = {
		...
		open : function() {
			// after 2.5 seconds, execute the function inside.
...
{					if( support ) {
		...
		positionPreview : function() {
			...
			console.log("below position");
			console.log(scrollExtra);
			console.log("below scrollExtra");
			var previewOffsetT = this.$previewEl.offset().top - scrollExtra;
			console.log(position);
			console.log("below previewOffsetT");
